...
var nameValidator = should_throw_default(with_message_default(compose_default(required_default(), matches_pattern_default(/.*-.*/)), `web component names are required and must contain a hyphen`));
var define_component_default = ({ name, emits, props = {}, setup, connectedCallback, disconnectedCallback, adoptedCallback, render, shadowMode = "closed", css }) => {
  var _context, _props, _shadowRoot, _setupResults, _render, _css, _doRender, doRender_fn, _updateProps, updateProps_fn, _a;
  ...
  const clazz = (_a = class extends HTMLElement {
    constructor() {
      ...
      __privateAdd(this, _setupResults, void 0);
      ...
      __privateSet(this, _setupResults, setup?.call(this, __privateGet(this, _props), __privateGet(this, _context)) || {});
      for (const [key, value] of Object.entries(__privateGet(this, _props))) {
        if (!__privateGet(this, _setupResults)[key]) {
          __privateGet(this, _setupResults)[key] = value;
        }
      }
    ...
    attributeChangedCallback(name2, oldValue, newValue) {
      __privateGet(this, _setupResults)[name2].next(newValue);
      __privateMethod(this, _doRender, doRender_fn).call(this);
    }
  }, _context = new WeakMap(), _props = new WeakMap(), _shadowRoot = new WeakMap(), _setupResults = new WeakMap(), _render = new WeakMap(), _css = new WeakMap(), _doRender = new WeakSet(), doRender_fn = function() {
    __privateGet(this, _shadowRoot).innerHTML = "";
    const state = {};
    Object.entries(__privateGet(this, _setupResults)).forEach(([key, value]) => {
    ...
    if (__privateGet(this, _render)) {
      ...
      templateElement.innerHTML = __privateGet(this, _render).call(this, state);
      const templateContent = templateElement.content;
      __privateGet(this, _shadowRoot).appendChild(templateContent.cloneNode(true));
    }
  }, _updateProps = new WeakSet(), updateProps_fn = function() {
    for (const [key, value] of Object.entries(__privateGet(this, _props))) {
