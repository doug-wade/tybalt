...
var define_component_default = ({
  ...
  }, _context = new WeakMap(), _props = new WeakMap(), _shadowRoot = new WeakMap(), _renderObservables = new WeakMap(), _renderState = new WeakMap(), _render = new WeakMap(), _css = new WeakMap(), _template = new WeakMap(), _isConnected = new WeakMap(), _doRender = new WeakSet(), doRender_fn = function() {
