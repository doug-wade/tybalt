...
var use_observable_default = ({ initialValue, subscriber }) => {
  ...
  const observer = new import_observable.default((observer2) => {
    handler = (event) => {
      return observer2.next(event);
    };
  });
  if (subscriber) {
...
// ../validator/dist/api/validator.js
...
// ../validator/dist/api/matches-pattern.js
...
// ../validator/dist/api/required.js
...
// ../validator/dist/util/validation-error.js
var ValidationError = class extends Error {
};

// ../validator/dist/api/should-throw.js
...
// ../validator/dist/util/ensure-validator.js
...
// ../validator/dist/api/with-message.js
...
var define_component_default = ({ name, emits, props = {}, setup, connectedCallback, disconnectedCallback, adoptedCallback, template, shadowMode = "closed" }) => {
  var _context, _props, _shadow, _a;
  ...
  const clazz = (_a = class extends HTMLElement {
    constructor() {
      ...
      __privateSet(this, _shadow, this.attachShadow({ mode: shadowMode }));
    ...
    connectedCallback() {
      ...
      const closure = setup?.call(this, __privateGet(this, _props), __privateGet(this, _context));
      __privateGet(this, _shadow).innerHTML = typeof template === "function" ? template(closure) : template;
    }
  ...
  }, _context = new WeakMap(), _props = new WeakMap(), _shadow = new WeakMap(), _a);
